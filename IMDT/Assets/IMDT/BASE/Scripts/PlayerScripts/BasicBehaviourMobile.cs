...
public class BasicBehaviourMobile : MonoBehaviour
{
	...
	private ThirdPersonOrbitCamBasicMobile camScript;                // Reference to the third person camera script.
	...
	public ThirdPersonOrbitCamBasicMobile GetCamScript { get { return camScript; } }
	...
	void Awake ()
	{
		...
		camScript = playerCamera.GetComponent<ThirdPersonOrbitCamBasicMobile> ();
...
public abstract class GenericBehaviour : MonoBehaviour
{
	...
	protected BasicBehaviourMobile behaviourManager;     // Reference to the basic behaviour manager.
	...
	{
		// Set up the references.
		behaviourManager = GetComponent<BasicBehaviourMobile> ();
